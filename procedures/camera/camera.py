...
def frame_image(focal_length, sensor_width, sensor_height, dist_to_target, size_of_target):
...
def square_has_plant():
    with PiCamera() as camera:
        ...
        camera.zoom = frame_image(FOCAL_LENGTH, sensor_width, sensor_height, DIST_FROM_LENSE_TO_GROUND, SIZE_OF_TARGET_ZONE)
        time.sleep(2)
